...
//These this is part of static filtering
// field2 will  not be send as response when the bean is returned
...
public class SomeBean {
    ...
    @JsonIgnore // field3 will  not be send as response when the bean is returned
